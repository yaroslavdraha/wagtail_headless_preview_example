"""
Django settings for wagtail_nextjs_preview project.
...
ROOT_URLCONF = 'wagtail_nextjs_preview.urls'
...
WSGI_APPLICATION = 'wagtail_nextjs_preview.wsgi.application'
...
WAGTAIL_SITE_NAME = "wagtail_nextjs_preview"
...
WAGTAIL_HEADLESS_PREVIEW = {
    ...
    "SERVE_BASE_URL": "http://localhost:3000",  # can be used for HeadlessServeMixin
